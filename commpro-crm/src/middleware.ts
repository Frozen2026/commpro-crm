...
const publicRoutes = new Set(["/", "/login", "/signup", "/coi-request"]);
...
/**
 * Keep this middleware sync and network-free.
 * Calling Supabase here causes MIDDLEWARE_INVOCATION_TIMEOUT when the
 * project URL is unreachable (e.g. localhost) or slow from the Edge.
 */
export function middleware(request: NextRequest) {
  ...
  // Public routes (including COI request form) — no auth work in middleware.
