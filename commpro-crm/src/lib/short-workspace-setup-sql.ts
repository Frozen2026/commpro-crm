/** Short DDL-only setup — no functions / DECLARE. Keep in sync with PASTE_SHORT_SETUP.sql */
export const SHORT_WORKSPACE_SETUP_SQL = `-- SHORT setup only (no functions). Paste into a NEW blank SQL Editor tab.
